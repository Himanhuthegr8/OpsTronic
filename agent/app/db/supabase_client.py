...
class Database:
    ...
    # =========================================================================
    # Users (GitHub OAuth — opstronic_users table)
    # =========================================================================
    ...
    async def upsert_user(
        ...
        """
        Create or update a row in opstronic_users on every GitHub OAuth login.
        ...
        try:
            ...
            self.client.table("opstronic_users").upsert(
    ...
    async def upsert_heartbeat(self, user_id: str, data: Dict[str, Any]) -> bool:
        ...
        Stores heartbeat fields directly on the opstronic_users row
    ...
    async def save_session_token(self, session_token: str, github_id: str) -> bool:
        ...
        The token is stored in opstronic_users.session_token.
        """
        if not self.client:
